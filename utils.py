...
def generate_new_name_from_text(file_name: str) -> str:
    ...
    prompt = f""" You are provided with an original name of a file. {file_name} Your task is to generate a new name for the file, using the original name. 
    ...
    Instructions:
        ...
        3) It should not have any dashes or underscores or special characters, and should be in title case and have alphabetical characters only.
        4) It should make sense and not sound incomplete. If you cannot complete the last word of the name, then come up with a name without using it.
